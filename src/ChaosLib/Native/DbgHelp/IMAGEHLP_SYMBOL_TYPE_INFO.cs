namespace ChaosLib
{
    ...
    public enum IMAGEHLP_SYMBOL_TYPE_INFO
    {
        ...
        /// <summary>
        /// The type index of all children. The data type is a pointer to a TI_FINDCHILDREN_PARAMS structure.
        ...
        /// <summary>
        /// A value that indicates whether the base class is virtually inherited. The data type is BOOL.
        /// </summary>
        ...
        /// <summary>
        /// A value that indicates whether the type index is nested. The data type is DWORD*.
        /// </summary>
        TI_GET_NESTED,
        ...
        /// <summary>
        /// The offset from the this pointer to its actual value. The data type is DWORD*.
        /// </summary>
        TI_GET_THISADJUST,
        ...
        /// <summary>
        /// The equivalency of two symbols. This is not guaranteed to be accurate. The data type is DWORD*. The value is S_OK is the two types are equivalent,
        /// and S_FALSE otherwise.
        /// </summary>
        TI_IS_CLOSE_EQUIV_TO,

        /// <summary>
        /// The element where the valid request bitfield should be stored. The data type is ULONG64*.
        /// This value is only used with the SymGetTypeInfoEx function.
        /// </summary>
        TI_GTIEX_REQS_VALID,

        /// <summary>
        /// The offset in the virtual function table of a virtual function. The data type is DWORD.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether the user-defined data type is an indirect virtual base. The data type is BOOL.
        /// </summary>
